<?php
/**
 * Kounselia — verified professional's profile & rate editor.
 *
 * Same boot pattern as dashboard.php/talk.php: wp-load.php only, no
 * theme. Gated to a signed-in user whose application
 * (kounselia_professionals) is 'verified' — anyone else gets sent back
 * to /apply.php, where they can see their actual status (pending,
 * rejected, or "you haven't applied").
 *
...
<div class="pro-wrap">
  <div class="pro-eyebrow">Verified professional</div>
  <h1>Your profile</h1>
  <p class="lead">This is what clients will see, and your rate is entirely yours to set — Kounselia never changes it for you.</p>
